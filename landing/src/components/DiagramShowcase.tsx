    ...
    return lines
        .map((line) => {
            ...
            processed = processed.replace(
                /\b(erDiagram|graph|sequenceDiagram|classDiagram|flowchart|subgraph|end|participant|actor|Note over|alt|else|autonumber|TB|LR|TD|RL|PK|FK|UK)\b/g,
            ...
            // Types / after colon
            processed = processed.replace(
                /\b(string|int|uuid|text|decimal|timestamp|enum|jsonb|Boolean|Decimal|DateTime|String|UUID|Int|void|Object|List)\b/g,
